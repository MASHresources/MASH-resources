...
<figure>
    <center>
        <img src="media/02_media/A_Downloading_R_and_RStudio_fig1.png" width="600" title="Figure 1"
             alt="An image showing the screen that can be seen when the link is clicked. In the top left corner, the link 'Download R 4.0.0 for Windows' is circled.">
...
<figure>
    <center>
        <img src="media/02_media/A_Downloading_R_and_RStudio_fig2.png" width="600" title="Figure 2"
             alt="An image showing the screen that can be seen when the link is clicked and the steps are followed. A series of bullet points with the options 'Download R for Linux', 'Download R for (Mac) OS X' and 'Download R for Windows' is circled.">
        <figcaption style="text-align:center">
...
<figure>
    <center>
        <img src="media/02_media/A_Downloading_R_and_RStudio_fig3.png" width="600" title="Figure 3"
             alt="An image showing the screen that can be seen when the link is clicked and the steps are followed. The 'Download' button for the free version of RStudio is circled.">
        <figcaption style="text-align:center">
