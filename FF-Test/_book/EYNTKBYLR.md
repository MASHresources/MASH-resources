...
> **R can do a huge amount. And if it cannot already do something you need, there is often a package that can help — or you can potentially create your own solution.**
...
![](EYNTKBYLR_files/figure-epub3/unnamed-chunk-5-1.png)<!-- -->
...
> **Tip:** You do not necessarily need to use `setwd()`. Instead, in the **Files** tab, click **...** on the right-hand side, click through the file explorer to find the folder you want then click **Open**. Click the cog symbol titled **More** then Select **Set as Working Directory**.
...
> Tip: To quickly highlight your entire script click **Ctrl + A** with your cursor anywhere in the script.
...
> **Good habit:** Write comments that help you — and someone else — understand what your code is doing.
...
### Errors
:::warning
:warning: **Help! I've got an Error !**
:::
...
:::info
:information_source: **When something goes wrong:**
...
:::success
:+1: **It is just as important to learn how to debug your code as it is learning to write code.**
:::
...
![](EYNTKBYLR_files/figure-epub3/unnamed-chunk-37-1.png)<!-- -->
...
![](EYNTKBYLR_files/figure-epub3/unnamed-chunk-38-1.png)<!-- -->
